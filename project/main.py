...
with open(r'C:\Users\Sanchari\Downloads\medical-supply-management-system-dbms-mini-project-master\medical-supply-management-system-dbms-mini-project-master', 'r') as c:
